...
helpers.chargePayment = function(amount, source, currency, description, metadata, callback) {
  ...
  metadata = typeof(metadata) == 'object' ? metadata : false;

  if (amount && source && currency && description && metadata) {
